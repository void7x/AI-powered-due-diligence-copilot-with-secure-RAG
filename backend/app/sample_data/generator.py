...
FY25_AR_PAGES: list[list[str]] = [
    ...
    ["# 3A. Key Operating Highlights",
     "FY2025 was a year of strong top-line growth alongside continued investment in capacity.",
     "Revenue increased 21.0% year over year, while operating income increased to 88.3.",
     "International revenue reached 38% of total, led by the Poland facility ramp.",
     "Management's FY2026 outlook calls for 10-12% revenue growth and gradual margin recovery."],
